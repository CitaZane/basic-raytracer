use crate::{ray::Ray, objects::Intersection, color::Color, point3d::Point3D};
...
impl Scatterable for Metal{
    fn scatter(&self, ray: &Ray, intersection: &Intersection) -> Option<(Ray, Color)>{
        ...
        if scattered.direction.dot(&intersection.normal) < 0.0{return None}
...
impl Light{
    pub fn new(intensity:f64)-> Self{
        Self{color: Color::white(), intensity}
    }
}
